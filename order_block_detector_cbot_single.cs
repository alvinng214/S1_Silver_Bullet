...
namespace cAlgo
{
    ...
    public class OrderBlockDetectorCbot : Robot
    {
        ...
        private void ExecuteSignalTrade(int signalBarIndex, int direction)
        {
            ...
            if (stopLossPips <= 0)
            {
                Print("Skipped trade. Invalid SL distance. Direction={0}, Entry={1}, SL={2}",
